        ...
        <nav className="hidden md:flex items-center gap-1 border-l border-[#1E2D3D] pl-3">
          return (
            <header className="relative h-12 bg-[#080D14] flex items-center justify-between px-4 shrink-0">
              ...
              {/* Logo & Live Badge */}
              <div className="flex items-center gap-4 min-w-0">
                <Link href="/" className="font-barlow font-black text-[#C8D6E5] text-xl tracking-[4px] uppercase hover:text-[#0EA5E9] transition-all duration-200 hover:[text-shadow:0_0_20px_rgba(14,165,233,0.5)] focus:outline-none focus:ring-2 focus:ring-[#0EA5E9]" aria-label="Home">
                  NovaStream
                </Link>
                <span className="text-[10px] font-barlow font-black tracking-[3px] text-[#2A4060] uppercase">
                  24/7
              ...
              <nav className="hidden md:flex items-center gap-1 border-l border-[#1E2D3D] pl-3" aria-label="Main Navigation">
                {navItems.map((item) => {
